...
```
`<button class="outline outline-offset-0 ...">Button A</button> <button class="outline outline-offset-2 ...">Button B</button> <button class="outline outline-offset-4 ...">Button C</button>`
```
...
```
`<button class="outline hover:outline-offset-2"> <!-- ... --> </button> `
```
...
```
`<button class="outline md:outline-offset-2"> <!-- ... --> </button> `
```
...
```
`module.exports={ theme:{ extend:{ outlineOffset:{ 3:'3px', } } } } `
```
...
```
`<button class="outline-offset-[3px]"> <!-- ... --> </button> `
```
...
[Outline Style](/docs/outline-style)[Ring Width](/docs/ring-width)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/outline-offset.mdx)
