...
```
`<div class="hue-rotate-15 ..."> <!-- ... --> </div> <div class="hue-rotate-90 ..."> <!-- ... --> </div> <div class="hue-rotate-180 ..."> <!-- ... --> </div> <div class="-hue-rotate-60 ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert hue-rotate-180 md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="hue-rotate-60 hover:hue-rotate-0"> <!-- ... --> </div> `
```
...
```
`<div class="hue-rotate-60 md:hue-rotate-0"> <!-- ... --> </div> `
```
...
```
`<div class="hue-rotate-[270deg]"> <!-- ... --> </div> `
```
...
[Grayscale](/docs/grayscale)[Invert](/docs/invert)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/hue-rotate.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fhue-rotate&r=&sid=PMFMDJGK&qs=%7B%7D&cid=59537591)
