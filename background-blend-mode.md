...
```
`<div class="bg-blend-lighten hover:bg-blend-darken"> <!-- ... --> </div> `
```
...
```
`<div class="bg-blend-lighten md:bg-blend-darken"> <!-- ... --> </div> `
```
...
[Mix Blend Mode](/docs/mix-blend-mode)[Blur](/docs/blur)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/background-blend-mode.mdx)
