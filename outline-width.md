...
```
`<button class="outline outline-offset-2 outline-1 ...">Button A</button> <button class="outline outline-offset-2 outline-2 ...">Button B</button> <button class="outline outline-offset-2 outline-4 ...">Button C</button>`
```
...
```
`<div class="outline hover:outline-2"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ outlineWidth:{ 5:'5px', } } } } `
```
...
[Divide Style](/docs/divide-style)[Outline Color](/docs/outline-color)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/outline-width.mdx)
