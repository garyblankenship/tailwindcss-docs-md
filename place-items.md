...
```
`<div class="grid grid-cols-3 gap-4 place-items-start ..."> <div>01</div> <div>02</div> <div>03</div> <div>04</div> <div>05</div> <div>06</div> </div>`
```
...
```
`<div class="grid grid-cols-3 gap-4 place-items-end h-56 ..."> <div>01</div> <div>02</div> <div>03</div> <div>04</div> <div>05</div> <div>06</div> </div>`
```
...
```
`<div class="grid grid-cols-3 gap-4 place-items-center h-56 ..."> <div>01</div> <div>02</div> <div>03</div> <div>04</div> <div>05</div> <div>06</div> </div>`
```
...
```
`<div class="grid grid-cols-3 gap-4 place-items-stretch h-56 ..."> <div>01</div> <div>02</div> <div>03</div> <div>04</div> <div>05</div> <div>06</div> </div>`
```
...
```
`<div class="grid place-items-start hover:place-items-center"> <!-- ... --> </div> `
```
...
[Place Content](/docs/place-content)[Place Self](/docs/place-self)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/place-items.mdx)
