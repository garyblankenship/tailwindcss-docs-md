...
```
`<img class="origin-center rotate-45 ..."> <img class="origin-top-left rotate-12 ..."> <img class="origin-bottom -rotate-12 ...">`
```
...
[Skew](/docs/skew)[Accent Color](/docs/accent-color)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/transform-origin.mdx)
