...
```
`<table class="hover:table-fixed"> <!-- ... --> </table> `
```
...
```
`<table class="md:table-fixed"> <!-- ... --> </table> `
```
...
[Border Spacing](/docs/border-spacing)[Caption Side](/docs/caption-side)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/table-layout.mdx)
