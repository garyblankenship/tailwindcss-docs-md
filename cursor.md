...
---|---|---  
cursor-auto| cursor: auto; | ![](/img/cursors/cursor-auto.svg)  
cursor-default| cursor: default; | ![](/img/cursors/cursor-default.svg)  
cursor-pointer| cursor: pointer; | ![](/img/cursors/cursor-pointer.svg)  
cursor-wait| cursor: wait; | ![](/img/cursors/cursor-wait.svg)  
cursor-text| cursor: text; | ![](/img/cursors/cursor-text.svg)  
cursor-move| cursor: move; | ![](/img/cursors/cursor-move.svg)  
cursor-help| cursor: help; | ![](/img/cursors/cursor-help.svg)  
cursor-not-allowed| cursor: not-allowed; | ![](/img/cursors/cursor-not-allowed.svg)  
cursor-none| cursor: none;   
cursor-context-menu| cursor: context-menu; | ![](/img/cursors/cursor-context-menu.svg)  
cursor-progress| cursor: progress; | ![](/img/cursors/cursor-progress.svg)  
cursor-cell| cursor: cell; | ![](/img/cursors/cursor-cell.svg)  
cursor-crosshair| cursor: crosshair; | ![](/img/cursors/cursor-crosshair.svg)  
cursor-vertical-text| cursor: vertical-text; | ![](/img/cursors/cursor-vertical-text.svg)  
cursor-alias| cursor: alias; | ![](/img/cursors/cursor-alias.svg)  
cursor-copy| cursor: copy; | ![](/img/cursors/cursor-copy.svg)  
cursor-no-drop| cursor: no-drop; | ![](/img/cursors/cursor-no-drop.svg)  
cursor-grab| cursor: grab; | ![](/img/cursors/cursor-grab.svg)  
cursor-grabbing| cursor: grabbing; | ![](/img/cursors/cursor-grabbing.svg)  
cursor-all-scroll| cursor: all-scroll; | ![](/img/cursors/cursor-all-scroll.svg)  
cursor-col-resize| cursor: col-resize; | ![](/img/cursors/cursor-col-resize.svg)  
cursor-row-resize| cursor: row-resize; | ![](/img/cursors/cursor-row-resize.svg)  
cursor-n-resize| cursor: n-resize; | ![](/img/cursors/cursor-n-resize.svg)  
cursor-e-resize| cursor: e-resize; | ![](/img/cursors/cursor-e-resize.svg)  
cursor-s-resize| cursor: s-resize; | ![](/img/cursors/cursor-s-resize.svg)  
cursor-w-resize| cursor: w-resize; | ![](/img/cursors/cursor-w-resize.svg)  
cursor-ne-resize| cursor: ne-resize; | ![](/img/cursors/cursor-ne-resize.svg)  
cursor-nw-resize| cursor: nw-resize; | ![](/img/cursors/cursor-nw-resize.svg)  
cursor-se-resize| cursor: se-resize; | ![](/img/cursors/cursor-se-resize.svg)  
cursor-sw-resize| cursor: sw-resize; | ![](/img/cursors/cursor-sw-resize.svg)  
cursor-ew-resize| cursor: ew-resize; | ![](/img/cursors/cursor-ew-resize.svg)  
cursor-ns-resize| cursor: ns-resize; | ![](/img/cursors/cursor-ns-resize.svg)  
cursor-nesw-resize| cursor: nesw-resize; | ![](/img/cursors/cursor-nesw-resize.svg)  
cursor-nwse-resize| cursor: nwse-resize; | ![](/img/cursors/cursor-nwse-resize.svg)  
cursor-zoom-in| cursor: zoom-in; | ![](/img/cursors/cursor-zoom-in.svg)  
cursor-zoom-out| cursor: zoom-out; | ![](/img/cursors/cursor-zoom-out.svg)  
...
Submit  Saving...  Confirm 

```
`<button type="button" class="cursor-pointer ..."> Submit </button> <button type="button" class="cursor-progress ..."> Saving... </button> <button type="button" disabled class="cursor-not-allowed ..."> Confirm </button>`
```
...
[Appearance](/docs/appearance)[Caret Color](/docs/caret-color)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/cursor.mdx)
