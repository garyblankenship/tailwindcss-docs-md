...
```
`<img class="skew-y-0 ..."> <img class="skew-y-3 ..."> <img class="skew-y-6 ..."> <img class="skew-y-12 ...">`
```
...
```
`<div class="skew-y-6 transform-gpu"> <!-- ... --> </div> `
```
...
[Translate](/docs/translate)[Transform Origin](/docs/transform-origin)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fskew&r=&sid=PMFMDJGK&qs=%7B%7D&cid=55462086)
