...
```
`<div class="backdrop-brightness-50 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-brightness-125 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-brightness-200 bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-brightness-110 hover:backdrop-brightness-150"> <!-- ... --> </div> `
```
...
[Backdrop Blur](/docs/backdrop-blur)[Backdrop Contrast](/docs/backdrop-contrast)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-brightness.mdx)
