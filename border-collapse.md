...
```
`<table class="hover:border-collapse"> <!-- ... --> </table> `
```
...
```
`<table class="md:border-collapse"> <!-- ... --> </table> `
```
...
[Backdrop Sepia](/docs/backdrop-sepia)[Border Spacing](/docs/border-spacing)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/border-collapse.mdx)
