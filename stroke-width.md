...
```
`<svg class="stroke-1 hover:stroke-2"> <!-- ... --> </svg> `
```
...
```
`<svg class="stroke-1 md:stroke-2"> <!-- ... --> </svg> `
```
...
```
`module.exports={ theme:{ extend:{ strokeWidth:{ '2':'2px', } } } } `
```
...
[Stroke](/docs/stroke)[Screen Readers](/docs/screen-readers)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/stroke-width.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fstroke-width&r=&sid=PMFMDJGK&qs=%7B%7D&cid=10498820)
