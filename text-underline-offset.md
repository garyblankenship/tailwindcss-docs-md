...
```
`<p class="underline hover:underline-offset-4"> <!-- ... --> </p> `
```
...
```
`module.exports={ theme:{ extend:{ textUnderlineOffset:{ 3:'3px', } } } } `
```
...
[Text Decoration Thickness](/docs/text-decoration-thickness)[Text Transform](/docs/text-transform)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-underline-offset.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftext-underline-offset&r=&sid=PMFMDJGK&qs=%7B%7D&cid=58379670)
