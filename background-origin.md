...
```
`<div class="bg-origin-border p-4 border-4 border-dashed ..." style="background-image: url(...)"></div> <div class="bg-origin-padding p-4 border-4 border-dashed ..." style="background-image: url(...)"></div> <div class="bg-origin-content p-4 border-4 border-dashed ..." style="background-image: url(...)"></div>`
```
...
```
`<div class="bg-origin-border hover:bg-origin-padding"> <!-- ... --> </div> `
```
...
[Background Color](/docs/background-color)[Background Position](/docs/background-position)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/background-origin.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackground-origin&r=&sid=PMFMDJGK&qs=%7B%7D&cid=65564587)
