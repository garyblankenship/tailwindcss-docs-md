...
```
`<button class="... ring-offset-2 ring-2">Button A</button> <button class="... ring-offset-2 ring">Button B</button> <button class="... ring-offset-2 ring-4">Button C</button>`
```
...
```
`<div class="ring-2 hover:ring-4"> <!-- ... --> </div> `
```
...
```
`<div class="ring-2 md:ring-4"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ ringWidth:{ '10':'10px', } } } } `
```
...
[Outline Offset](/docs/outline-offset)[Ring Color](/docs/ring-color)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/ring-width.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fring-width&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76883420)
