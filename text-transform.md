...
```
`<p class="capitalize hover:uppercase"> <!-- ... --> </p> `
```
...
[Text Underline Offset](/docs/text-underline-offset)[Text Overflow](/docs/text-overflow)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-transform.mdx)
