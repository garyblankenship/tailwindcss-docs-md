...
```
`<div class="backdrop-grayscale-0 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-grayscale bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-grayscale md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-grayscale hover:backdrop-grayscale-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ backdropGrayscale:{ 50:'.5', } } } } `
```
...
```
`<div class="backdrop-grayscale-[.5]"> <!-- ... --> </div> `
```
...
[Backdrop Contrast](/docs/backdrop-contrast)[Backdrop Hue Rotate](/docs/backdrop-hue-rotate)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-grayscale.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-grayscale&r=&sid=PMFMDJGK&qs=%7B%7D&cid=12269756)
