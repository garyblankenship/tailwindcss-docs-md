...
```
`<div class="grid grid-flow-col justify-stretch ..."> <div>01</div> <div>02</div> <div>03</div> </div>`
```
...
```
`<div class="flex justify-start hover:justify-between"> <!-- ... --> </div> `
```
...
[Gap](/docs/gap)[Justify Items](/docs/justify-items)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/justify-content.mdx)
