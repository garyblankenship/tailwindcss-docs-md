...
```
`<ul class="list-outside hover:list-inside"> <!-- ... --> </ul> `
```
...
[List Style Image](/docs/list-style-image)[List Style Type](/docs/list-style-type)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/list-style-position.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Flist-style-position&r=&sid=PMFMDJGK&qs=%7B%7D&cid=43192335)
