...
```
`<div class="bg-indigo-300 ..."> <img class="object-cover h-48 w-96 ..."> </div>`
```
...
```
`<div class="bg-purple-300 ..."> <img class="object-contain h-48 w-96 ..."> </div>`
```
...
```
`<div class="bg-sky-300 ..."> <img class="object-fill h-48 w-96 ..."> </div>`
```
...
```
`<div class="bg-cyan-300"> <img class="object-scale-down h-48 w-96 ..."> </div>`
```
...
```
`<div class="bg-yellow-300"> <img class="object-none h-48 w-96 ..."> </div>`
```
...
[Isolation](/docs/isolation)[Object Position](/docs/object-position)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/object-fit.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fobject-fit&r=&sid=PMFMDJGK&qs=%7B%7D&cid=16447667)
