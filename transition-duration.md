...
```
`<div class="transition duration-0 hover:duration-150"> <!-- ... --> </div> `
```
...
```
`<div class="transition duration-0 md:duration-150"> <!-- ... --> </div> `
```
...
[Transition Property](/docs/transition-property)[Transition Timing Function](/docs/transition-timing-function)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/transition-duration.mdx)
