...
```
`<div class="grid grid-cols-4 gap-4"> <div>01</div> <!-- ... --> <div>05</div> <div class="grid grid-cols-subgrid gap-4 col-span-3"> <div class="col-start-2">06</div> </div> </div>`
```
...
```
`<div class="grid grid-cols-1 hover:grid-cols-6"> <!-- ... --> </div> `
```
...
[Order](/docs/order)[Grid Column Start / End](/docs/grid-column)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/grid-template-columns.mdx)
