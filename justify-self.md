...
```
`<div class="justify-self-start hover:justify-self-end"> <!-- ... --> </div> `
```
...
[Justify Items](/docs/justify-items)[Align Content](/docs/align-content)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/justify-self.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fjustify-self&r=&sid=PMFMDJGK&qs=%7B%7D&cid=62684064)
