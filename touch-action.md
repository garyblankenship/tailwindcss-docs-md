...
```
`<div class="focus:touch-pan-x"> <!-- ... --> </div> `
```
...
[Scroll Snap Type](/docs/scroll-snap-type)[User Select](/docs/user-select)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/touch-action.mdx)
