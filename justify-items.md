...
```
`<div class="grid justify-items-start hover:justify-items-center"> <!-- ... --> </div> `
```
...
[Justify Content](/docs/justify-content)[Justify Self](/docs/justify-self)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/justify-items.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fjustify-items&r=&sid=PMFMDJGK&qs=%7B%7D&cid=17377924)
