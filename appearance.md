...
```
`<select> <option>Yes</option> <option>No</option> <option>Maybe</option> </select> <div class="grid"> <select class="appearance-none row-start-1 col-start-1 bg-slate-50 dark:bg-slate-800 ..."> <option>Yes</option> <option>No</option> <option>Maybe</option> </select> <svg class="pointer-events-none row-start-1 col-start-1 ..."> <!-- ... --> </svg> </div>`
```
...
```
`<div class="appearance-auto hover:appearance-none"> <!-- ... --> </div> `
```
...
```
`<div class="appearance-auto md:appearance-none"> <!-- ... --> </div> `
```
...
[Accent Color](/docs/accent-color)[Cursor](/docs/cursor)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fappearance&r=&sid=PMFMDJGK&qs=%7B%7D&cid=66496537)
