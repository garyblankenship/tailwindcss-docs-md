...
```
`<html class="overscroll-auto focus:overscroll-contain"> <!-- ... --> </html> `
```
...
```
`<html class="overscroll-auto md:overscroll-contain"> <!-- ... --> </html> `
```
...
[Overflow](/docs/overflow)[Position](/docs/position)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/overscroll-behavior.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Foverscroll-behavior&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76108343)
