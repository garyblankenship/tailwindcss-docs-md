...
```
`<div class="backdrop-sepia-0 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-sepia bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-sepia md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-sepia hover:backdrop-sepia-0"> <!-- ... --> </div> `
```
...
[Backdrop Saturate](/docs/backdrop-saturate)[Border Collapse](/docs/border-collapse)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-sepia.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-sepia&r=&sid=PMFMDJGK&qs=%7B%7D&cid=29382684)
