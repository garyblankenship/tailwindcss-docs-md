...
```
`<div class="saturate-50 ..."> <!-- ... --> </div> <div class="saturate-100 ..."> <!-- ... --> </div> <div class="saturate-150 ..."> <!-- ... --> </div> <div class="saturate-200 ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert saturate-150 md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="saturate-50 hover:saturate-150"> <!-- ... --> </div> `
```
...
```
`<div class="saturate-50 md:saturate-150"> <!-- ... --> </div> `
```
...
[Invert](/docs/invert)[Sepia](/docs/sepia)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/saturate.mdx)
