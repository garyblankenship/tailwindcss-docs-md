...
```
`<p class="truncate hover:text-clip"> <!-- ... --> </p> `
```
...
```
`<p class="truncate md:text-clip"> <!-- ... --> </p> `
```
...
[Text Transform](/docs/text-transform)[Text Wrap](/docs/text-wrap)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-overflow.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftext-overflow&r=&sid=PMFMDJGK&qs=%7B%7D&cid=89017153)
