...
```
`module.exports={ theme:{ extend:{ gridAutoColumns:{ '2fr':'minmax(0, 2fr)', } } } } `
```
...
```
`<div class="grid grid-flow-col auto-cols-[minmax(0,_2fr)]"> <!-- ... --> </div> `
```
...
[Grid Auto Flow](/docs/grid-auto-flow)[Grid Auto Rows](/docs/grid-auto-rows)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/grid-auto-columns.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fgrid-auto-columns&r=&sid=PMFMDJGK&qs=%7B%7D&cid=2922624)
