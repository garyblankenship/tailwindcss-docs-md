...
```
`<div class="sr-only md:not-sr-only"> <!-- ... --> </div> `
```
...
[Stroke Width](/docs/stroke-width)[Forced Color Adjust](/docs/forced-color-adjust)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/screen-readers.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fscreen-readers&r=&sid=PMFMDJGK&qs=%7B%7D&cid=53877797)
