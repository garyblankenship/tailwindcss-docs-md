...
```
`<div class="hover:break-before-column"> <!-- ... --> </div> `
```
...
[Break After](/docs/break-after)[Break Inside](/docs/break-inside)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/break-before.mdx)
