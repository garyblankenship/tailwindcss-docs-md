...
```
`<div class="bg-auto hover:bg-contain"> <!-- ... --> </div> `
```
...
[Background Repeat](/docs/background-repeat)[Background Image](/docs/background-image)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/background-size.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackground-size&r=&sid=PMFMDJGK&qs=%7B%7D&cid=90580260)
