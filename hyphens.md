...
```
`<p class="hyphens-none hover:hyphens-auto"> <!-- ... --> </p> `
```
...
[Word Break](/docs/word-break)[Content](/docs/content)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/hyphens.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fhyphens&r=&sid=PMFMDJGK&qs=%7B%7D&cid=93372813)
