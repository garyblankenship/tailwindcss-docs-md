...
```
`<div class="bg-repeat hover:bg-repeat-x"> <!-- ... --> </div> `
```
...
[Background Position](/docs/background-position)[Background Size](/docs/background-size)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/background-repeat.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackground-repeat&r=&sid=PMFMDJGK&qs=%7B%7D&cid=84096157)
