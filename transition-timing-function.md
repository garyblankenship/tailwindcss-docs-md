...
```
`module.exports={ theme:{ extend:{ transitionTimingFunction:{ 'in-expo':'cubic-bezier(0.95, 0.05, 0.795, 0.035)', 'out-expo':'cubic-bezier(0.19, 1, 0.22, 1)', } } } } `
```
...
[Transition Duration](/docs/transition-duration)[Transition Delay](/docs/transition-delay)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/transition-timing-function.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftransition-timing-function&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76860704)
