...
```
`<div class="blur-none ..."> <!-- ... --> </div> <div class="blur-sm ..."> <!-- ... --> </div> <div class="blur-lg ..."> <!-- ... --> </div> <div class="blur-2xl ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur hover:blur-lg"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ blur:{ xs:'2px', } } } } `
```
...
[Background Blend Mode](/docs/background-blend-mode)[Brightness](/docs/brightness)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/blur.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fblur&r=&sid=PMFMDJGK&qs=%7B%7D&cid=48947736)
