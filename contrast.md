...
```
`<div class="contrast-50 ..."> <!-- ... --> </div> <div class="contrast-100 ..."> <!-- ... --> </div> <div class="contrast-125 ..."> <!-- ... --> </div> <div class="contrast-200 ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert contrast-125 md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="contrast-125 hover:contrast-150"> <!-- ... --> </div> `
```
...
```
`<div class="contrast-125 md:contrast-150"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ contrast:{ 25:'.25', } } } } `
```
...
[Brightness](/docs/brightness)[Drop Shadow](/docs/drop-shadow)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/contrast.mdx)
