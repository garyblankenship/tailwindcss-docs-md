...
```
`<img class="scale-75 ..."> <img class="scale-100 ..."> <img class="scale-125 ...">`
```
...
```
`module.exports={ theme:{ extend:{ scale:{ '175':'1.75', } } } } `
```
...
[Animation](/docs/animation)[Rotate](/docs/rotate)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/scale.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fscale&r=&sid=PMFMDJGK&qs=%7B%7D&cid=17571273)
