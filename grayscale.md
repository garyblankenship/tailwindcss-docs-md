...
```
`<div class="grayscale-0 ..."> <!-- ... --> </div> <div class="grayscale ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert grayscale md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="grayscale hover:grayscale-0"> <!-- ... --> </div> `
```
...
```
`<div class="grayscale md:grayscale-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ grayscale:{ 50:'50%', } } } } `
```
...
[Drop Shadow](/docs/drop-shadow)[Hue Rotate](/docs/hue-rotate)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/grayscale.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fgrayscale&r=&sid=PMFMDJGK&qs=%7B%7D&cid=50135703)
