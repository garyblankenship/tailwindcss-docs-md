...
```
`<div class="brightness-50 ..."> <!-- ... --> </div> <div class="brightness-100 ..."> <!-- ... --> </div> <div class="brightness-125 ..."> <!-- ... --> </div> <div class="brightness-200 ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert brightness-150 md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="brightness-110 hover:brightness-150"> <!-- ... --> </div> `
```
...
```
`<div class="brightness-110 md:brightness-150"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ brightness:{ 25:'.25', 175:'1.75', } } } } `
```
...
[Blur](/docs/blur)[Contrast](/docs/contrast)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/brightness.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbrightness&r=&sid=PMFMDJGK&qs=%7B%7D&cid=74206355)
