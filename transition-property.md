...
```
`<button class="transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none ..."> Hover me </button>`
```
...
```
`<div class="hover:transition-all"> <!-- ... --> </div> `
```
...
```
`<div class="md:transition-all"> <!-- ... --> </div> `
```
...
[Caption Side](/docs/caption-side)[Transition Duration](/docs/transition-duration)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/transition-property.mdx)
