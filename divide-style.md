...
```
`<div class="divide-y divide-dashed"> <div>01</div> <div>02</div> <div>03</div> </div>`
```
...
```
`<div class="divide-y divide-dashed hover:divide-solid"> <!-- ... --> </div> `
```
...
```
`<div class="divide-y divide-dashed md:divide-solid"> <!-- ... --> </div> `
```
...
[Divide Color](/docs/divide-color)[Outline Width](/docs/outline-width)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/divide-style.mdx)
