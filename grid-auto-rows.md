...
```
`module.exports={ theme:{ extend:{ gridAutoRows:{ '2fr':'minmax(0, 2fr)', } } } } `
```
...
```
`<div class="grid grid-flow-row auto-rows-[minmax(0,_2fr)]"> <!-- ... --> </div> `
```
...
[Grid Auto Columns](/docs/grid-auto-columns)[Gap](/docs/gap)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/grid-auto-rows.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fgrid-auto-rows&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76433045)
