...
Out of the box, `list-image-none` is the only available preconfigured list style image utility. And while you can add additional utilities by [customizing your theme](/docs/list-style-image#customizing-your-theme), you can also use the square bracket notation to generate an arbitrary value on the fly.
...
```
`<ul class="list-image-[url(checkmark.png)] ..."> <li>5 cups chopped Porcini mushrooms</li> <!-- ... --> </ul>`
```
...
```
`<ul class="list-image-none hover:list-image-[url(checkmark.png)]"> <!-- ... --> </ul> `
```
...
```
`<ul class="list-image-none md:list-image-[url(checkmark.png)]"> <!-- ... --> </ul> `
```
...
```
`module.exports={ theme:{ extend:{ listStyleImage:{ checkmark:'url("/img/checkmark.png")', }, } } } `
```
...
```
`<ul class="list-image-[url(checkmark.png)]"> <!-- ... --> </ul> `
```
...
[Line Height](/docs/line-height)[List Style Position](/docs/list-style-position)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/list-style-image.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Flist-style-image&r=&sid=PMFMDJGK&qs=%7B%7D&cid=6549191)
