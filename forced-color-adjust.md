...
![Two each of gray, white, and black shirts laying flat.](/img/t-shirt.jpg)
...
```
`<form> <img src="..." /> <div> <h3>Basic Tee</h3> <h3>$35</h3> <fieldset> <legend class="sr-only">Choose a color</legend> <div class="forced-color-adjust-none ..."> <label > <input class="sr-only" type="radio" name="color-choice" value="White" /> <span class="sr-only">White</span> <span class="size-6 rounded-full border border-black border-opacity-10 bg-white"></span> </label> <!-- ... --> </div> </fieldset> </form>`
```
...
```
`<a href="#content" class="forced-color-adjust-none focus:forced-color-adjust-auto"> Skip to content </a>`
```
...
[Screen Readers](/docs/screen-readers)[Typography](https://github.com/tailwindlabs/tailwindcss-typography)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/forced-color-adjust.mdx)
