...
```
`<div class="flex flex-col hover:flex-row"> <!-- ... --> </div> `
```
...
[Flex Basis](/docs/flex-basis)[Flex Wrap](/docs/flex-wrap)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/flex-direction.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fflex-direction&r=&sid=PMFMDJGK&qs=%7B%7D&cid=22465650)
