...
```
`<html class="scroll-smooth focus:scroll-auto"> <!-- ... --> </html> `
```
...
[Resize](/docs/resize)[Scroll Margin](/docs/scroll-margin)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/scroll-behavior.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fscroll-behavior&r=&sid=PMFMDJGK&qs=%7B%7D&cid=69526148)
