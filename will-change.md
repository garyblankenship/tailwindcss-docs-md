...
```
`<div class="will-change-auto hover:will-change-scroll"> <!-- ... --> </div> `
```
...
```
`<div class="will-change-auto md:will-change-scroll"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ willChange:{ 'left-top':'left, top', } } } } `
```
...
[User Select](/docs/user-select)[Fill](/docs/fill)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/will-change.mdx)
