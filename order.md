...
```
`<div class="order-first hover:order-last"> <!-- ... --> </div> `
```
...
[Flex Shrink](/docs/flex-shrink)[Grid Template Columns](/docs/grid-template-columns)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/order.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Forder&r=&sid=PMFMDJGK&qs=%7B%7D&cid=88021770)
