...
```
`<div class="sepia-0 ..."> <!-- ... --> </div> <div class="sepia ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert sepia md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="sepia hover:sepia-0"> <!-- ... --> </div> `
```
...
```
`<div class="sepia md:sepia-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ sepia:{ 25:'.25', 75:'.75', } } } } `
```
...
[Saturate](/docs/saturate)[Backdrop Blur](/docs/backdrop-blur)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/sepia.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fsepia&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76653887)
