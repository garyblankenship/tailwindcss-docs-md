...
```
`<p class="underline ...">The quick brown fox ...</p> <p class="overline ...">The quick brown fox ...</p> <p class="line-through ...">The quick brown fox ...</p> <p class="no-underline ...">The quick brown fox ...</p>`
```
...
```
`<p class="no-underline md:underline"> <!-- ... --> </p> `
```
...
[Text Color](/docs/text-color)[Text Decoration Color](/docs/text-decoration-color)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-decoration.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftext-decoration&r=&sid=PMFMDJGK&qs=%7B%7D&cid=33523853)
