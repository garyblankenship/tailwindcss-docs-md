...
```
`<p class="underline hover:decoration-4"> <!-- ... --> </p> `
```
...
```
`module.exports={ theme:{ extend:{ textDecorationThickness:{ 3:'3px', } } } } `
```
...
[Text Decoration Style](/docs/text-decoration-style)[Text Underline Offset](/docs/text-underline-offset)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-decoration-thickness.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftext-decoration-thickness&r=&sid=PMFMDJGK&qs=%7B%7D&cid=97788685)
