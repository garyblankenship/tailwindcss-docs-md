...
```
`module.exports={ theme:{ extend:{ transitionDelay:{ '2000':'2000ms', } } } } `
```
...
[Transition Timing Function](/docs/transition-timing-function)[Animation](/docs/animation)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/transition-delay.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftransition-delay&r=&sid=PMFMDJGK&qs=%7B%7D&cid=79035329)
