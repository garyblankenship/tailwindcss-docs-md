...
```
`<p class="line-clamp-3 hover:line-clamp-4"> <!-- ... --> </p> `
```
...
```
`<p class="line-clamp-3 md:line-clamp-4"> <!-- ... --> </p> `
```
...
[Letter Spacing](/docs/letter-spacing)[Line Height](/docs/line-height)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/line-clamp.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fline-clamp&r=&sid=PMFMDJGK&qs=%7B%7D&cid=71237930)
