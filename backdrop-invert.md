...
```
`<div class="backdrop-invert-0 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-invert bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-invert md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-invert hover:backdrop-invert-0"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-invert md:backdrop-invert-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ backdropInvert:{ 25:'.25', 75:'.75', } } } } `
```
...
[Backdrop Hue Rotate](/docs/backdrop-hue-rotate)[Backdrop Opacity](/docs/backdrop-opacity)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-invert.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-invert&r=&sid=PMFMDJGK&qs=%7B%7D&cid=76795612)
