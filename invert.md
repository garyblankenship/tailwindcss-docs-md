...
```
`<div class="invert-0 ..."> <!-- ... --> </div> <div class="invert ..."> <!-- ... --> </div>`
```
...
```
`<div class="invert hover:invert-0"> <!-- ... --> </div> `
```
...
```
`<div class="invert md:invert-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ invert:{ 25:'.25', 50:'.5', 75:'.75', } } } } `
```
...
[Hue Rotate](/docs/hue-rotate)[Saturate](/docs/saturate)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/invert.mdx)
