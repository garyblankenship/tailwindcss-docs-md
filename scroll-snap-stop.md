...
```
`<div class="snap-always hover:snap-normal"> <!-- ... --> </div> `
```
...
[Scroll Snap Align](/docs/scroll-snap-align)[Scroll Snap Type](/docs/scroll-snap-type)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/scroll-snap-stop.mdx)
