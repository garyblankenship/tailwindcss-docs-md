...
```
`<div class="backdrop-saturate-50 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-saturate-125 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-saturate-200 bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-saturate-150 md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-saturate-50 hover:backdrop-saturate-150"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ backdropSaturate:{ 25:'.25', } } } } `
```
...
[Backdrop Opacity](/docs/backdrop-opacity)[Backdrop Sepia](/docs/backdrop-sepia)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-saturate.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-saturate&r=&sid=PMFMDJGK&qs=%7B%7D&cid=1373668)
