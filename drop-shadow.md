...
```
`<div class="drop-shadow-md ..."> <!-- ... --> </div> <div class="drop-shadow-lg ..."> <!-- ... --> </div> <div class="drop-shadow-xl ..."> <!-- ... --> </div> <div class="drop-shadow-2xl ..."> <!-- ... --> </div>`
```
...
```
`<div class="blur-md invert drop-shadow-xl md:filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="drop-shadow-md hover:drop-shadow-xl"> <!-- ... --> </div> `
```
...
```
`<div class="drop-shadow-md md:drop-shadow-xl"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ dropShadow:{ '3xl':'0 35px 35px rgba(0, 0, 0, 0.25)', '4xl':[ '0 35px 35px rgba(0, 0, 0, 0.25)', '0 45px 65px rgba(0, 0, 0, 0.15)' ] } } } } `
```
...
[Contrast](/docs/contrast)[Grayscale](/docs/grayscale)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/drop-shadow.mdx)
