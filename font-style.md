...
```
`<p class="italic ...">The quick brown fox ...</p> <p class="not-italic ...">The quick brown fox ...</p>`
```
...
```
`<p class="italic hover:not-italic"> <!-- ... --> </p> `
```
...
[Font Smoothing](/docs/font-smoothing)[Font Weight](/docs/font-weight)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/font-style.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ffont-style&r=&sid=PMFMDJGK&qs=%7B%7D&cid=16029687)
