...
```
`<div class="backdrop-contrast-50 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-contrast-125 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-contrast-200 bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-contrast-125 md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-contrast-125 hover:backdrop-contrast-150"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ backdropContrast:{ 25:'.25', } } } } `
```
...
[Backdrop Brightness](/docs/backdrop-brightness)[Backdrop Grayscale](/docs/backdrop-grayscale)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-contrast.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-contrast&r=&sid=PMFMDJGK&qs=%7B%7D&cid=29874954)
