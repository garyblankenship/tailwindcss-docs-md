...
```
`<div class="grid grid-cols-3 gap-2 ..."> <div>01</div> <div class="place-self-stretch ...">02</div> <div>03</div> <div>04</div> <div>05</div> <div>06</div> </div>`
```
...
```
`<div class="place-self-start hover:place-self-end"> <!-- ... --> </div> `
```
...
[Place Items](/docs/place-items)[Padding](/docs/padding)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/place-self.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fplace-self&r=&sid=PMFMDJGK&qs=%7B%7D&cid=20055826)
