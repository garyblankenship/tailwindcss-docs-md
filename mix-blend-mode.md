...
```
`<div class="flex justify-center -space-x-14"> <div class="mix-blend-multiply bg-blue-400 ..."></div> <div class="mix-blend-multiply bg-pink-400 ..."></div> </div>`
```
...
```
`<div class="mix-blend-multiply hover:mix-blend-overlay"> <!-- ... --> </div> `
```
...
[Opacity](/docs/opacity)[Background Blend Mode](/docs/background-blend-mode)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/mix-blend-mode.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fmix-blend-mode&r=&sid=PMFMDJGK&qs=%7B%7D&cid=52555620)
