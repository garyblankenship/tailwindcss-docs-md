...
### [​Specifying stop positions](#specifying-stop-positions)
...
### [​Fading to transparent](#fading-to-transparent)
...
```
`<div class="bg-gradient-to-r from-blue-500 to-transparent"> <!-- ... --> </div>`
```
...
```
`<button type="button" class="bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 ..."> Hover me </button>`
```
...
```
`<div class="from-teal-400 to-blue-500 hover:from-purple-500 hover:to-blue-500 ..."> <!-- ... --> </div>`
```
...
By default, Tailwind makes the entire [default color palette](/docs/customizing-colors#default-color-palette) available as gradient colors. You can [customize your color palette](/docs/colors#customizing) by editing `theme.colors` or `theme.extend.colors` in your `tailwind.config.js` file.
...
```
`module.exports={ theme:{ extend:{ gradientColorStopPositions:{ 33:'33%', } } } } `
```
...
[Background Image](/docs/background-image)[Border Radius](/docs/border-radius)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/gradient-color-stops.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fgradient-color-stops&r=&sid=PMFMDJGK&qs=%7B%7D&cid=7317447)
