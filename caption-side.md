...
```
`<table class="caption-top hover:caption-bottom"> <!-- ... --> </table> `
```
...
```
`<table class="caption-top md:caption-bottom"> <!-- ... --> </table> `
```
...
[Table Layout](/docs/table-layout)[Transition Property](/docs/transition-property)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/caption-side.mdx)
