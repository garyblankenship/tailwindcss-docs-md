...
```
`<h1 class="text-wrap hover:text-balance"> <!-- ... --> </h1> `
```
...
```
`<h1 class="text-wrap md:text-balance"> <!-- ... --> </h1> `
```
...
[Text Overflow](/docs/text-overflow)[Text Indent](/docs/text-indent)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/text-wrap.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Ftext-wrap&r=&sid=PMFMDJGK&qs=%7B%7D&cid=74781162)
