...
```
`<div class="flex ..."> <div class="flex-none w-14 h-14 ..."> 01 </div> <div class="grow h-14 ..."> 02 </div> <div class="flex-none w-14 h-14 ..."> 03 </div> </div>`
```
...
```
`<div class="flex ..."> <div class="grow h-14 ..."> 01 </div> <div class="grow-0 h-14 ..."> 02 </div> <div class="grow h-14 ..."> 03 </div> </div>`
```
...
```
`<div class="grow hover:grow-0"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ flexGrow:{ 2:'2' } } } } `
```
...
[Flex](/docs/flex)[Flex Shrink](/docs/flex-shrink)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/flex-grow.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fflex-grow&r=&sid=PMFMDJGK&qs=%7B%7D&cid=89676924)
