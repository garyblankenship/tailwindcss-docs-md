...
```
`<div class="backdrop-hue-rotate-90 bg-white/30 ..."> <!-- ... --> </div> <div class="backdrop-hue-rotate-180 bg-white/30 ..."> <!-- ... --> </div> <div class="-backdrop-hue-rotate-60 bg-white/30 ..."> <!-- ... --> </div>`
```
...
```
`<div class="-backdrop-hue-rotate-60"> <!-- ... --> </div>`
```
...
```
`<div class="backdrop-blur-md backdrop-hue-rotate-180 md:backdrop-filter-none"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-hue-rotate-15 hover:backdrop-hue-rotate-60"> <!-- ... --> </div> `
```
...
```
`<div class="backdrop-hue-rotate-15 md:backdrop-hue-rotate-60"> <!-- ... --> </div> `
```
...
```
`module.exports={ theme:{ extend:{ backdropHueRotate:{ '-270':'-270deg', 270:'270deg', } } } } `
```
...
```
`<div class="backdrop-hue-rotate-[270deg]"> <!-- ... --> </div> `
```
...
[Backdrop Grayscale](/docs/backdrop-grayscale)[Backdrop Invert](/docs/backdrop-invert)

Copyright © 2025 Tailwind Labs Inc.

[Trademark Policy](/brand)

[Edit this page on GitHub](https://github.com/tailwindlabs/tailwindcss.com/edit/master/src/pages/docs/backdrop-hue-rotate.mdx)
...
![](https://cdn.usefathom.com/?h=https%3A%2F%2Ftailwindcss.com&p=%2Fdocs%2Fbackdrop-hue-rotate&r=&sid=PMFMDJGK&qs=%7B%7D&cid=50190239)
